...
import cn.enncy.funny.pojo.EmailValidator;
...
public class MailController {
    ...
    public MailController(HttpSession session, MailUtils mailUtil) {
    ...
    public String sendVerifyCode(@RequestParam("email") String email ) throws ServiceException {
        ...
        String verifyCode = MailUtils.createVerifyCode(6);
